...
class Daoguest{
    ...
    //Cette  méthode permet de supprimer les tables si elles existes pour les recréer à chaque fois car pour tester on doit tout le temps reinitialiser la base.
